...
import { FaGithub, FaLinkedin, FaTelegram, FaDownload, FaCode, FaLaptopCode } from 'react-icons/fa';
    ...
    <section id="home" className="hero-section" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
      ...
      >
        ...
        <motion.div
          ...
          style={{ fontSize: '2rem', marginBottom: '2rem', height: '48px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
        >
        ...
        <motion.p
          ...
          style={{ fontSize: '1.125rem', marginBottom: '3rem', maxWidth: '32rem', margin: '0 auto 3rem auto', lineHeight: '1.6' }}
        >
        ...
        <motion.div
          variants={itemVariants}
          style={{ display: 'flex', flexDirection: 'column', gap: '1rem', justifyContent: 'center', alignItems: 'center', marginBottom: '3rem' }}
        >
          <motion.button
        ...
        >
          {[
            { icon: FaGithub, href: '#', color: '#9ca3af' },
            { icon: FaLinkedin, href: '#', color: '#60a5fa' },
            { icon: FaTelegram, href: '#', color: '#60a5fa' },
          ].map((social, index) => (
            <motion.a
              key={index}
              href={social.href}
